...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mMEHEDI HASAN

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801735381911

\x1b[93;1m Facebook Page      \x1b[92;1m=>      \x1b[93;1𝐈𝐭'𝐬 𝐌𝐫 𝐗࿐
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100086256310523")

		exit()

	else:

		os.system("https://www.facebook.com/profile.php?id=100086256310523")
...
def crack2(idf,pwv):
	...
	print('\r%s [MEHEDI] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [MEHEDI-CP] %s|%s        '%(b,idf,pw))
